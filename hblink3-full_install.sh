#!/bin/bash
# K7ILO's HBlink3, FDMR-Monitor, Firewall Installer, V2.1 -----------------------------------------------------------------------------------
...
echo " Also check to see if FDMR-Monitor is running by typing: systemctl status fdmr_mon "
...
echo ""
echo " Now access the FDMR-Monitor Dashboard with your favorite browser by going to the "
